x<-read.csv("/home/bd/Dropbox/projects/rt_meta/data/0_raw/ecls/childK5p_Flankers.csv")
x$id<-x$CHILDID
...
save(x,file=paste("/home/bd/Dropbox/projects/irt_meta/data/ecls_flanker.Rdata",sep=""))

x<-read.csv("/home/bd/Dropbox/projects/rt_meta/data/0_raw/ecls/childK5p_DCCS.csv")
x$id<-x$CHILDID
...
summary(x$rt)
x$item<-paste("item_",x$item,sep="")
save(x,file=paste("/home/bd/Dropbox/projects/irt_meta/data/ecls_dccs.Rdata",sep=""))
